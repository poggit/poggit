...
function login(a,b){"undefined"===typeof a&&(a=window.location.toString());ajax("persistLoc",{data:{path:a},success:function(){window.location=b?getRelativeRootPath()+"login":"https://github.com/login/oauth/authorize?client_id="+getClientId()+"&state="+getAntiForge()}})}function logout(){ajax("logout",{success:function(){window.location.reload(!0)}})}
function homeBumpNotif(a){a=void 0===a?!0:a;ajax("session.bumpnotif");a&&setTimeout(function(){window.location=getRelativeRootPath()+"plugins"},500)}function hideTos(){ajax("hideTos",{success:function(){$("#remind-tos").css("display","none")}})}
