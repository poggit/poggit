...
class PocketMineApi {
    ...
    public static $VERSIONS = [
        ...
        "3.0.0-ALPHA11" => ["description" => ["New XP API", "ArmorInventory", "LevelProvider can be constructed without a Level", "VoxelRayTrace", "NBTStream", "TextFormat::colorize()"], "php" => ["7.2"], "incompatible" => true, "indev" => true, ],
    ];
}
