...
<p>Login on the Poggit website and authorize the Poggit application for your user account or your organizations.
...
<p> You do not need to edit the poggit.yml file for Poggit to add a repo, but this example shows what Poggit can do:</p>
...
<h3>Release: Apply for approval to the 'Plugin List'</h3>
...
<li>Releases cannot be created from private repos. You must publicize your repo if you want to create
    plugin releases from it.</li>
<li>For convenience of reviewing plugins, and to reduce waiting times, please avoid force-pushing that modifies commit history of existing releases.</li>
</ol>
...
<p>The Poggit project is currently under development, hosted on a private server. The full source code is available at <a target="_blank" href='https://github.com/poggit/poggit'>https://github.com/poggit/poggit</a>. As of Nov 25 2016, Poggit-CI is considered functional, but other parts of the website are incomplete.</p>
