            ...
            <body>
                ...
                <div id="body">
                    ...
                    <div class="helpwrapper">
                        ...
                        <p> You do not need to edit the poggit.yml file for Poggit to add a repo, but you will find an example of what Poggit can do at the end of theis page</p>
                        ...
                        <p>Appointed reviewers will review plugins in the "Unofficial" and "Deep" queues to move them to the official release list,
                            where they benefit from all the features of Poggit Release.</p>

                        <h2>Advanced Features</h2>

                        <p>When you enable a plugin in your repo list you are prompted to confirm the contents of the .poggit.yml file that Poggit creates for you.
                            Usually you can accept the default setting and click "Confirm", but you can also configure the file manually. For example:
