...
class ReleaseSubmitHelpModule extends Module {
    ...
    public function output() {
        ...
        <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
            <?php $this->headIncludes("Poggit Help: Submitting plugins", "Help information about submitting plugins to Poggit Release") ?>
            <title>Submitting Plugins | Help | Poggit</title>
        </head>
        <body>
        <?php $this->bodyHeader() ?>
        <div id="body">
            <h1 class="topic">Submitting Plugins</h1>
            <div class="toggle" data-name="Plugin submission flow">
                <!-- TODO edit this, replace with flowchart -->
                <ol>
                    ...
                    <li>Reputed members can review the plugin
                        <ul>
                            ...
                            <li>If enough reputed members approve it, it will be moved to the &quot;unofficially
                                approved
                                queue&quot;
                            </li>
                        </ul>
                    </li>
                    <li>All users can see plugins in &quot;unofficially approved queue&quot;, but with limited features
                        and
            ...
            <div class="toggle" data-name="Plugin submission rules">
                <!-- TODO improve this -->
                    ...
                    <li>Plugin release:
                        <ol>
                            ...
                            <li>Do not advertise Minecraft servers, YouTube channels, personal websites, etc. in
                                ...
                                listening English, or whatever language you use! Poggit Release is for users from all
                                over
                                the world.
                            </li>
