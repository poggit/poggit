...
$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(b,a){return $jscomp.findInternal(this,b,a).v}},"es6","es3");var briefEnabledRepos={},currentRepoId,maxrows=30,databuilds=[],datareleases=[],classPfx={1:"dev",4:"pr"},humanstates="Draft Rejected Submitted Checked Voted Approved Featured".split(" ");
...
!1!==sessionData.opts.usePages?"on":"off")&&$("#repolistbuildwrapper").paginate({perPage:12,scope:$("div")})});function testWebhook(b,c){ajax("ci.webhookTest",{data:{owner:b,name:c},success:function(a){console.log(a)}})}var toggleProjectSub=function(b,c){var a=$("#project-subscribe");a.addClass("disabled");a.prop("onclick",null).off("click");ajax("ci.project.togglesub",{data:{projectId:b,level:c},success:function(){window.location.reload(!0)}})};
