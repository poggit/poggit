...
($("#repo-"+a.repoId).remove(),$("#prj-"+a.repoId).text("0")),b.dialog("close"),$("#btn-"+a.repoId).toggles(a.enabled),$("#confirm").attr("disabled",!1)):alert(a.message)}})}var h=$("#inputSearch"),e=$("#inputUser"),l=$("#inputRepo"),p=$("#inputProject"),r=$("#inputBuild"),q=$("#gotoRecent"),B=$("#gotoAdmin"),C=$("#gotoSelf"),y=$("#gotoSearch"),u=$("#gotoUser"),v=$("#gotoRepo"),w=$("#gotoProject"),x=$("#gotoBuild"),n=function(){var a=!e.val().trim(),c=!(e.val().trim()&&l.val().trim()),d=!(e.val().trim()&&
l.val().trim()&&p.val().trim()),f=!(e.val().trim()&&l.val().trim()&&p.val().trim()&&r.val().trim());u.hasClass("disabled")!==a&&u.toggleClass("disabled");v.hasClass("disabled")!==c&&v.toggleClass("disabled");w.hasClass("disabled")!==d&&w.toggleClass("disabled");x.hasClass("disabled")!==f&&x.toggleClass("disabled")};if(0!==window.location.hash.length){var z=$("a[name="+window.location.hash.substring(1)+"]").parent().offset();"undefined"!==typeof z&&$("html, body").animate({scrollTop:z.top},300)}"/ci"!==
window.location.pathname||sessionData.session.isLoggedIn||window.history.replaceState(null,"","/ci/recent");e.keydown(function(){setTimeout(n,50)});e.change(n);e.keyup(function(a){13===a.keyCode&&u.click()});h.keydown(function(){setTimeout(n,50)});h.change(n);h.keyup(function(a){13===a.keyCode&&y.click()});l.keydown(function(){setTimeout(n,50)});l.change(n);l.keyup(function(a){13===a.keyCode&&v.click()});p.keydown(function(){setTimeout(n,50)});p.change(n);p.keyup(function(a){13===a.keyCode&&w.click()});
