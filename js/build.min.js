...
":"+p.val()});$("#rbp-dl-direct").click(function(a){confirm("This is a development build; it has not been reviewed. It may contain dangerous code including virus. Do you still want to download this file?")||a.preventDefault()});$("#rbp-dl-as").click(function(){var a=this.getAttribute("data-rsr-id"),b=this.getAttribute("data-dl-name");confirm("This is a development build; it has not been reviewed. It may contain dangerous code including virus. Do you still want to download this file?")&&(b=prompt("Filename to download with:",
b),null!==b&&(window.location=getRelativeRootPath()+"r/"+a+"/"+b))});$("#toggle-project-sub").click(function(){var a=this.getAttribute("data-project-id"),b=document.getElementById("select-project-sub").value,c=$("#project-subscribe");c.addClass("disabled");c.prop("onclick",null).off("click");ajax("ci.project.togglesub",{data:{projectId:a,level:b},success:function(){window.location.reload(!0)}})});var y=$("#enableRepoBuilds");(function(){var b=$("#toggle-orgs");0!==b.length&&(b.empty(),a(getLoginName(),
...
scope:$("div")});12<$("#repolistbuildwrapper > div").length&&"on"===getParameterByName("usePages",!1!==sessionData.opts.usePages?"on":"off")&&$("#repolistbuildwrapper").paginate({perPage:12,scope:$("div")})});
