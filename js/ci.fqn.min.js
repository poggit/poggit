...
return this.$div};fqnRoot=new e("",0,null);$("#tree-container").append(fqnRoot.$());$("#sort-fqn").change(function(){switch(this.value){case "SORT_NAME_NO_CASE":var a=k;break;case "SORT_NAME_CASE":a=m;break;case "SORT_ID":a=n;break;case "SORT_ID_REVERSE":a=p}f=a;fqnRoot.resort()})});
