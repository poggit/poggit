...
" online").css("display","list-item")}})});function ajax(a,b){$.post(getRelativeRootPath()+"csrf/csrf--"+a,{},function(c){void 0===b&&(b={});void 0===b.dataType&&(b.dataType="json");void 0===b.data&&(b.data={});"undefined"===typeof b.headers&&(b.headers=[]);b.headers["X-Poggit-CSRF"]=c;$.ajax(getRelativeRootPath()+a,b)})}
