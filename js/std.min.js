...
Object.indexOfKey=function(a,b){var c=0,d;for(d in a){if(d===b)return c;++c}};Object.getKeyByIndex=function(a,b){var c=0;b=Number(b);for(var d in a)if(a.hasOwnProperty(d)&&c++===Number(b))return d};Object.getValueByIndex=function(a,b){var c=0;b=Number(b);for(var d in a)if(a.hasOwnProperty(d)&&c++===Number(b))return a[d]};Object.valuesToArray=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(a[c]);return b};
Object.keysToArray=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b};Object.sizeof=function(a){var b=0,c;for(c in a)a.hasOwnProperty(c)&&++b;return b};
