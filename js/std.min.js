...
function login(a,b){"undefined"===typeof a&&(a=window.location.toString());ajax("persistLoc",{data:{path:a},success:function(){window.location=b?getRelativeRootPath()+"login":"https://github.com/login/oauth/authorize?client_id="+getClientId()+"&state="+getAntiForge()+"&scope="+encodeURIComponent("repo,read:org")}})}function logout(){ajax("logout",{success:function(){window.location.reload(!0)}})}
