...
void 0===String.prototype.ucfirst&&(String.prototype.ucfirst=function(){return this.charAt(0).toUpperCase()+this.substr(1)});void 0===String.prototype.startsWith&&(String.prototype.startsWith=function(a){return this.substring(0,a.length)===a});void 0===String.prototype.countSubstr&&(String.prototype.countSubstr=function(a){for(var b=0,c=0;-1!==(c=this.indexOf(a,c));c+=1)++b;return b});
void 0===String.prototype.countRegExp&&(String.prototype.countRegExp=function(a){-1===a.flags.indexOf("g")&&(a=new RegExp(a,a.flags+"g"));return this.match(a).length});void 0===String.prototype.ulTrim&&(String.prototype.ulTrim=function(a){for(var b=0,c=0;c<this.length;++c)-1!==a.indexOf(this.charAt(c))&&(b=c+1);return this.substr(b)});
void 0===String.prototype.urTrim&&(String.prototype.urTrim=function(a){for(var b=this.length,c=this.length-1;0<=c;--c)-1!==a.indexOf(this.charAt(c))&&(b=c);return this.substr(0,b)});void 0===String.prototype.uTrim&&(String.prototype.uTrim=function(a){return this.ulTrim(a).urTrim(a)});void 0===Math.sign&&(Math.sign=function(a){return 0===a?0:0<a?1:-1});void 0===Math.compare&&(Math.compare=function(a,b){return Math.sign(a-b)});
void 0===Array.prototype.includes&&(Array.prototype.includes=function(a){return 0<=this.indexOf(a)});void 0===RegExp.escape&&(RegExp.escape=function(a){return a.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")});Object.indexOfKey=function(a,b){var c=0,d;for(d in a){if(d===b)return c;++c}};Object.getKeyByIndex=function(a,b){var c=0;b=Number(b);for(var d in a)if(a.hasOwnProperty(d)&&c++===Number(b))return d};
