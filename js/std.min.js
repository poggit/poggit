...
function getParameterByName(a,b){var c=window.location.href;a=a.replace(/[\[\]]/g,"\\$&");return(a=(new RegExp("[?&]"+a+"(=([^&#]*)|&|#|$)")).exec(c))?a[2]?decodeURIComponent(a[2].replace(/\+/g," ")):"":"undefined"===typeof b?null:b}function getCookie(a,b){a=document.cookie.replace(new RegExp("(?:(?:^|.*;\\s*)"+RegExp.escape(a)+"\\s*\\=\\s*([^;]*).*$)|^.*$"),"$1");return""===a?b:a}function getRelativeRootPath(){return sessionData.path.relativeRoot}
