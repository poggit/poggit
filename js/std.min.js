...
function gaEventRelease(a,b,c){ga("send","event","Download.Stability","Release");ga("send","event","Download.Release.Content",b+" "+c);ga("send","event","Download.Release.Position",a?"Top":"Bottom")}var lastCancel;
