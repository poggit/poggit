...
$(this).tooltip();$(this).find("#togglewrapper").each(function(){toggleFunc($(this))});$(this).find('li[data-target="'+window.location.pathname.substring(getRelativeRootPath().length)+window.location.search+'"]').each(function(){$(this).addClass("active")});$(this).find(".time").each(timeTextFunc);$(this).find(".domain").each(domainFunc);timeElapseLoop();$(this).find(".dynamic-anchor").each(dynamicAnchor);$("#home-timeline").tabs({collapsible:!0})});var knownReviews={};
function ajax(a,b){$.post(getRelativeRootPath()+"csrf/csrf--"+a,{},function(c){void 0===b&&(b={});void 0===b.dataType&&(b.dataType="json");void 0===b.data&&(b.data={});"undefined"===typeof b.headers&&(b.headers=[]);b.headers["X-Poggit-CSRF"]=c;$.ajax(getRelativeRootPath()+a,b)})}
...
function promptDownloadResource(a,b){b=prompt("Filename to download with:",b);null!==b&&(window.location=getRelativeRootPath()+"r/"+a+"/"+b)}function homeBumpNotif(){ajax("session.bumpnotif");setTimeout(function(){window.location=getRelativeRootPath()+"plugins"},500)}
