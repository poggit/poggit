...
e).click(function(){var b=confirm("This "+(2===projectData.project.projectType?"virion":"plugin")+" has not been reviewed, and it may contain dangerous code including viruses. Do you still want to download this file?");gaEventCi(!0,!b,projectData.project.projectName,a.resourceId,!1);return b})).appendTo(c);2===projectData.project.projectType&&$("<td class='ci-project-history-virion-version'></td>").text(a.virionVersion).appendTo(c);D(a);return a.$row=c}function D(b){ghApi("repositories/"+projectData.project.repoId+
"/commits/"+b.sha,{},"GET",function(a){b.commitMessage=a.commit?a.commit.message:"unknown";b.authorName=a.commit?a.commit.author.name:"unknown";b.authorLogin=a.commit?a.author.login:"unknown";E(a.sha,b.commitMessage,b.authorName,b.authorLogin)})}function E(b,a,c,d){$("span.ci-build-commit-message[data-sha='"+b+"']").each(function(){var b=$(this);b.empty();b.text(a.split("\n")[0]);$("<span class='ci-build-commit-details'></span>").text(a.split("\n").slice(1).join("\n")).appendTo(b);$("<a target='_blank'></a>").attr("href",
"https://github.com/"+d).attr("title",c).append($("<img width='16'/>").attr("src","https://github.com/"+d+".png?width=20").css("margin","5px")).prependTo(b)})}function u(b){return function(){$(this).find(".ci-build-commit-details").css("display",b?"block":"none")}}var p={},q=null,m=$("#ci-build-inner"),y=$("#ci-build-pane");$("#ci-build-close").click(function(){h(!0)});var B=$("#ci-build-header"),v=!1,w,z=!1,C=null;m.find(".ci-build-commit-message").hover(u(!0),u(!1));var t=function(){var b;return function(a){if("undefined"!==
typeof b)return b;if(a)return null;b=$("<div id='build-pane-dialog'></div>");b.dialog({autoOpen:!1,modal:!0,position:modalPosition,close:function(){z||h(!0)},open:function(a,b){$(".ui-widget-overlay").bind("click",function(){$("#build-pane-dialog").dialog("close")})}});return b}}(),n={showNarrow:function(){var b=t();b.dialog("option","title",B.text());m.appendTo(b);c(b);b.dialog("open")},hideNarrow:function(){var b=t();z=!0;b.dialog("close");z=!1},showWide:function(){m.appendTo(y);y.css("display",
"flex")},hideWide:function(){y.css("display","none")}};(function(){function b(a){w=a;v&&(a?(n.hideWide(),n.showNarrow()):(n.hideNarrow(),n.showWide()))}var a=window.matchMedia("(max-width: 1000px)");b(a.matches);a.addListener(function(a){b(a.matches)});$(window).resize(function(){var a=t(!0);null!==a&&c(a)})})();window.addEventListener("popstate",function(){r(!0)});r(!1);var G=document.getElementById("projectPath"),A=/^https:\/\/github\.com\/([a-z\d](?:[a-z\d]|-(?=[a-z\d])){0,38})\/([a-z0-9_.-]+)\/tree\/master\/?(.*)/i.exec(G.href);
